...
转载于http://www.runoob.com/python/python-date-time.html
...
摘抄于https://www.cnblogs.com/PrettyTom/p/6657984.html
...
def Speak(name):
    ...
    global timer
    timer = threading.Timer(2.0, Speak, ["sword.zhang"])
    timer.start()
